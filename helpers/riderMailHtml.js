exports.riderDynamicMail = (link, editedRiderName)=>{
                ...
                <tr>
                    <td>
                        <div style="padding: 0 2.5em; text-align: center; margin-bottom: 0px;">
                            ...
                            <h3 style="font-family: 'Lato', sans-serif; font-size: 22px; font-weight: 400;">Welcome On Board , ${editedRiderName}</h3>
                            <p>Click the button below to verify your  email as a new rider</p>
